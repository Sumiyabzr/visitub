...
class MtBogdGolf extends StatefulWidget {
  const MtBogdGolf({super.key});

  @override
  State<MtBogdGolf> createState() => _MtBogdGolfState();
}

class _MtBogdGolfState extends State<MtBogdGolf> {
  ...
  final List<String> ServicesImage = [
     // services
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Service/MTBogdGolfClubService-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Service/MTBogdGolfClubService-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Service/MTBogdGolfClubService-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Service/MTBogdGolfClubService-4.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Service/MTBogdGolfClubService-5.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Service/MTBogdGolfClubService-6.jpg'
  ];

  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Top/MTBogdGolfClubTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Top/MTBogdGolfClubTop-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1..MTBogdGolfClub/Top/MTBogdGolfClubTop-3.jpg'
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'Sky Resort: Premier ski and golf resort in Ulaanbaatar, offering year-round recreational activities.',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.87849;
                                double longitude = 107.04298;
