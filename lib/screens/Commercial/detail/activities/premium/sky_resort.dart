...
class SkyResort extends StatefulWidget {
  const SkyResort({super.key});

  @override
  State<SkyResort> createState() => _SkyResortState();
}

class _SkyResortState extends State<SkyResort> {
  ...
  final List<String> ServicesImage = [
     // services
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1.Sky resort/Service/Service1/SkyresortService-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1.Sky resort/Service/Service2/SkyResortService-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1.Sky resort/Service/Service3/SkyResortService-1.jpg',
  ];

  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1.Sky resort/Top/SkyresortTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1.Sky resort/Top/SkyresortTop-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1.Sky resort/Top/SkyresortTop-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Activities/1.Sky resort/Top/SkyresortTop-4.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.87812;
                                double longitude = 107.04464;
