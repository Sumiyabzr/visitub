...
class Bodios extends StatefulWidget {
  const Bodios({super.key});

  @override
  State<Bodios> createState() => _BodiosState();
}

class _BodiosState extends State<Bodios> {
  ...
  final List<String> ServicesImage = [
     // services
    'http://192.168.1.111:8000/asset/Commercial/Fashion/Bodios/Bodios%20(1%20of%2014).jpg',
    'http://192.168.1.111:8000/asset/Commercial/Fashion/Bodios/Bodios%20(2%20of%2014).jpg',
    'http://192.168.1.111:8000/asset/Commercial/Fashion/Bodios/Bodios%20(3%20of%2014).jpg',
    'http://192.168.1.111:8000/asset/Commercial/Fashion/Bodios/Bodios%20(5%20of%2014).jpg'
  ];

  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/Bodios Mongolia/Top/BodiosMongoliaTop-1.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.90941;
                                double longitude = 106.78058;
                          ...
                          child: showYoutubePlayer
                            ...
                            : Stack(
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/Fashion/Bodios Mongolia/Thumbnail/BodiosMongoliaThumbnail-1.jpg'), fit: BoxFit.cover),
                                    borderRadius: BorderRadius.circular(10)
                                  ),
                                  width: size.width,
                                  height: size.height * 0.25,
