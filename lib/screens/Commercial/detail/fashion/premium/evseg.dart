...
class _EvsegState extends State<Evseg> {
 late YoutubePlayerController _youtubeController;
  ...
  final List<String> ServicesImage = [
     // services
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Product/EvsegProduct-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Product/EvsegProduct-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Product/EvsegProduct-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Product/EvsegProduct-7.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Product/EvsegProduct-8.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Product/EvsegProduct-6.jpg',
  ];

  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Top/EvsegTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Top/EvsegTop-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Top/EvsegTop-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Top/EvsegTop-4.jpg',
  ];
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image: NetworkImage(
                                            'http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Thumbnail/EvsegThumbnail-16.jpg'
                                          ),
                                          fit: BoxFit.cover)),
                               ...
                               Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      decoration: BoxDecoration(
                                        image: DecorationImage(image: NetworkImage(ServicesImage[5]), fit: BoxFit.cover),
                                        borderRadius: BorderRadius.circular(10),
                                        color: Colors.red
                                      ),
                                      width: size.width * 0.43,
                          ...
                          child: showYoutubePlayer
                            ...
                            : Stack(
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/Fashion/3.Evseg/Thumbnail/EvsegThumbnail-19.jpg'), fit: BoxFit.cover),
                                    borderRadius: BorderRadius.circular(10)
                                  ),
                                  width: size.width,
                                  height: size.height * 0.25,
