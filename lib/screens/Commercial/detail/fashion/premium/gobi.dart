...
class GoBi extends StatefulWidget {
  const GoBi({super.key});

  @override
  State<GoBi> createState() => _GoBiState();
}

class _GoBiState extends State<GoBi> {
 late YoutubePlayerController _youtubeController;
  ...
  final List<String> ServicesImage = [
     // services
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-4.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-5.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-6.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-7.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-8.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Product/GobiProduct-9.jpg',
  ];

  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Top/GobiTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Top/GobiTop-2.jpg'
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.92031;
                                double longitude = 106.91915;
                          ...
                          child: showYoutubePlayer
                            ...
                            : Stack(
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/Fashion/2.Gobi/Thumbnail/GobiThumbnail-1.jpg'), fit: BoxFit.cover),
                                    borderRadius: BorderRadius.circular(10)
                                  ),
                                  width: size.width,
                                  height: size.height * 0.25,
