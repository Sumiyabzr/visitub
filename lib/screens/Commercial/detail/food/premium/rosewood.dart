...
class Rosewood extends StatefulWidget {
  const Rosewood({super.key});

  @override
  State<Rosewood> createState() => _RosewoodState();
}

class _RosewoodState extends State<Rosewood> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Food/1.Rosewood/Top/RoseWoodTop-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Food/1.Rosewood/Top/RoseWoodTop-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Food/1.Rosewood/Top/RoseWoodTop-1.jpg',
  ];

  final List<String> RoomImage = [
     // Product
    'http://192.168.1.111:8000/asset/Commercial-new/Food/1.Rosewood/Product/RoseWoodProduct-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Food/1.Rosewood/Product/RoseWoodProduct-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Food/1.Rosewood/Product/RoseWoodProduct-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Food/1.Rosewood/Product/RoseWoodProduct-4.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'Rosewood Kitchen + Enoteca: Italian-inspired cuisine with locally sourced ingredients in Ulaanbaatar.',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.91014;
                                double longitude = 106.91495;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/Food/1.Rosewood/Menu/RoseWoodMenu-1.jpg'),
                                fit: BoxFit.cover),
                                borderRadius: BorderRadius.circular(10)
                              ),
                              width: size.width,
