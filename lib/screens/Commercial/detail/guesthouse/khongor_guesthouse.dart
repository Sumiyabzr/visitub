...
class KhongorGuesthouse extends StatefulWidget {
  const KhongorGuesthouse({super.key});

  @override
  State<KhongorGuesthouse> createState() => _KhongorGuesthouseState();
}

class _KhongorGuesthouseState extends State<KhongorGuesthouse> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/4.Khongor Guesthouse/Top/KhongorGuesthouseTop-1.jpg',
  ];

  final List<String> RoomImage = [
     // Rooms
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/4.Khongor Guesthouse/Room/KhongorGuesthouseRoom-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/4.Khongor Guesthouse/Room/KhongorGuesthouseRoom-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/4.Khongor Guesthouse/Room/KhongorGuesthouseRoom-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/4.Khongor Guesthouse/Room/KhongorGuesthouseRoom-4.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.91638;
                                double longitude = 106.90399;
