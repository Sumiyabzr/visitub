...
class UbGuesthouse extends StatefulWidget {
  const UbGuesthouse({super.key});

  @override
  State<UbGuesthouse> createState() => _UbGuesthouseState();
}

class _UbGuesthouseState extends State<UbGuesthouse> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/UB Guesthouse& tour/Top/UBGuestHouseTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/UB Guesthouse& tour/Top/UBGuestHouseTop-2.jpg',
  ];

  final List<String> RoomImage = [
     // Rooms
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/UB Guesthouse& tour/Room/UBGuestHouseRooms-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/UB Guesthouse& tour/Room/UBGuestHouseRooms-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/UB Guesthouse& tour/Room/UBGuestHouseRooms-3.jpg',
  ];

  final List<String> ServicesImage = [
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/UB Guesthouse& tour/Service/LGGuestHouseService-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/UB Guesthouse& tour/Service/LGGuestHouseService-1.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'UB Guesthouse: Popular guesthouse offering affordable rooms and tours in Ulaanbaatar.',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.91973;
                                double longitude = 106.91098;
