...
class UlaanbaatarHostel extends StatefulWidget {
  const UlaanbaatarHostel({super.key});

  @override
  State<UlaanbaatarHostel> createState() => _UlaanbaatarHostelState();
}

class _UlaanbaatarHostelState extends State<UlaanbaatarHostel> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/3.Ulaanbaatar Hostel/Top/UlaanbaatarHostelTop-1.jpg',
  ];

  final List<String> RoomImage = [
     // Rooms
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/3.Ulaanbaatar Hostel/Room/UlaanbaatarHostelRoom-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/3.Ulaanbaatar Hostel/Room/UlaanbaatarHostelRoom-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/3.Ulaanbaatar Hostel/Room/UlaanbaatarHostelRoom-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/3.Ulaanbaatar Hostel/Room/UlaanbaatarHostelRoom-4.jpg',
  ];

  final List<String> ServicesImage = [
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/LG GuestHouse/Service/LGGuestHouseService-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Guesthouse/LG GuestHouse/Service/LGGuestHouseService-3.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.92481;
                                double longitude = 106.91252;
