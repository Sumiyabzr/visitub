...
class SongdoCommercial extends StatefulWidget {
  const SongdoCommercial({super.key});

  @override
  State<SongdoCommercial> createState() => _SongdoCommercialState();
}

class _SongdoCommercialState extends State<SongdoCommercial> {
  ...
  final List<String> ServicesImage = [
     // services
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Service/SongdoService-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Service/SongdoService-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Service/SongdoService-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Service/SongdoService-4.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Service/SongdoService-5.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Service/SongdoService-6.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Service/SongdoService-7.jpg',
  ];

  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Top/SongdoTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hospital/Songdo/Top/SongdoTop-2.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'Songdo Hospital: Leading international-standard hospital in Ulaanbaatar, providing advanced medical care and services.',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.91628;
                                double longitude = 106.92271;
