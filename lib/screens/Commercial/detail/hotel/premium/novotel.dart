...
class Novotel extends StatefulWidget {
  const Novotel({super.key});

  @override
  State<Novotel> createState() => _NovotelState();
}

class _NovotelState extends State<Novotel> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Hotel/Novotel/Top/NovotelTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hotel/Novotel/Top/NovotelTop-2.jpg'
  ];

  final List<String> RoomImage = [
     // Rooms
    'http://192.168.1.111:8000/asset/Commercial-new/Hotel/Novotel/Room/NovotelRoom-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hotel/Novotel/Room/NovotelRoom-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hotel/Novotel/Room/NovotelRoom-3.jpg',
  ];

  final List<String> ConferenceRoom = [
    'http://192.168.1.111:8000/asset/Commercial-new/Hotel/Novotel/Hurliin tanhim/Khurliin tankhim1/NovotelKhurliinTankhim-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Hotel/Novotel/Hurliin tanhim/Khurliin tankhim2/NovotelKhurliinTankhim-2.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'Novotel Ulaanbaatar: Modern hotel in city center, offering upscale rooms near major attractions.',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.92663;
                                double longitude = 106.91713;
