                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: NetworkImage(
                                      'http://192.168.1.83:8000/asset/Commercial/Nightlife/ExoticVipClub/ExoticVipClubP (3 of 3).jpg'),
                                  fit: BoxFit.cover)),
                        )),
                    SafeArea(
                      child: IconButton(
                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                          image: DecorationImage(
                              image: NetworkImage(
                                  'http://192.168.1.83:8000/asset/Commercial/Nightlife/ExoticVipClub/ExoticVipClubP (2 of 3).jpg'),
                              fit: BoxFit.cover),
                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                          image: DecorationImage(
                              image: NetworkImage(
                                  'http://192.168.1.83:8000/asset/Commercial/Nightlife/ExoticVipClub/ExoticVipClubP (1 of 3).jpg'),
                              fit: BoxFit.cover),
                          borderRadius: BorderRadius.circular(15),
                        ),
                        width: size.width * 0.44,
