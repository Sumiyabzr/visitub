                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(
                                    'http://192.168.1.83:8000/asset/Commercial/Nightlife/PremiereLounge/PremiereE (1 of 5).jpg'),
                                fit: BoxFit.cover)),
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          image: DecorationImage(
                              image: NetworkImage(
                                  'http://192.168.1.83:8000/asset/Commercial/Nightlife/PremiereLounge/PremiereE (2 of 5).jpg'),
                              fit: BoxFit.cover),
                          borderRadius: BorderRadius.circular(15),
                        ),
                        width: size.width * 0.44,
                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                          image: DecorationImage(
                              image: NetworkImage(
                                  'http://192.168.1.83:8000/asset/Commercial/Nightlife/PremiereLounge/PremiereE (3 of 5).jpg'),
                              fit: BoxFit.cover),
                          borderRadius: BorderRadius.circular(15),
                        ),
                        width: size.width * 0.44,
                      ...
                      Container(
                        decoration: BoxDecoration(
                          image: DecorationImage(
                              image: NetworkImage(
                                  'http://192.168.1.83:8000/asset/Commercial/Nightlife/PremiereLounge/PremiereE (4 of 5).jpg'),
                              fit: BoxFit.cover),
                          borderRadius: BorderRadius.circular(15),
                        ),
                        width: size.width * 0.44,
