...
class Choco extends StatefulWidget {
  const Choco({super.key});

  @override
  State<Choco> createState() => _ChocoState();
}

class _ChocoState extends State<Choco> {
late YoutubePlayerController _youtubeController;
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/2.Choco/Top/ChocoTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/2.Choco/Top/ChocoTop-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/2.Choco/Top/ChocoTop-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/2.Choco/Top/ChocoTop-4.jpg',
  ];

  final List<String> RoomImage = [
     // Services
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/2.Choco/Service/Service1/ChocoService1-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/2.Choco/Service/Service2/ChocoService2-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/2.Choco/Service/Service3/ChocoService3-1.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'A luxury upscale VIP bottle service club located in the heart of midtown Ulaanbaatar, Mongolia.',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.91318;
                                double longitude = 106.90358;
                                  ...
                                  children: [ 
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text('Service 1', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700),),
                                    ...
                                    children: [ 
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.end,
                                          children: [
                                            Text('Service 2', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700),),
                                            // Text('30m2 | 2 persons', style: TextStyle(color: HexColor('#1862FF')),)
                                          ],
                                        ),
                                      )
                                    ...
                                    children: [ 
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.end,
                                          children: [
                                            Text('Service 3', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700),),
                                            // Text('30m2 | 2 persons', style: TextStyle(color: HexColor('#1862FF')),)
                                          ],
                                        ),
                                      )
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/NightLife/2.Choco/Menu/ChocoMenu-1.jpg'),
                                fit: BoxFit.cover),
                                borderRadius: BorderRadius.circular(10)
                              ),
                              width: size.width,
