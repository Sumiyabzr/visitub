...
class Eon extends StatefulWidget {
  const Eon({super.key});

  @override
  State<Eon> createState() => _EonState();
}

class _EonState extends State<Eon> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/4.Eon/Top/EonTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/4.Eon/Top/EonTop-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/4.Eon/Top/EonTop-3.jpg',
  ];

  final List<String> RoomImage = [
     // Services
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/4.Eon/SServices/Service1/Service1-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/4.Eon/SServices/Service2/Service2-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/4.Eon/SServices/Service3/Service3-1.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'eOn Clublex is a place where the reality matches the hype. The ultimate destination for you.',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.88593;
                                double longitude = 106.91613;
