...
class _MintState extends State<Mint> {
  ...
  final List<String> TopImage = [
    // TOP
    'http://192.168.1.83:8000/asset/Commercial-new/NightLife/3.Mint/Top/MintTop-1.jpg',
    'http://192.168.1.83:8000/asset/Commercial-new/NightLife/3.Mint/Top/MintTop-2.jpg',
    'http://192.168.1.83:8000/asset/Commercial-new/NightLife/3.Mint/Top/MintTop-3.jpg',
  ];

  final List<String> RoomImage = [
    // Services
    'http://192.168.1.83:8000/asset/Commercial-new/NightLife/3.Mint/Service/Service1/MintService1-1.jpg',
    'http://192.168.1.83:8000/asset/Commercial-new/NightLife/3.Mint/Service/Service2/MintService-1.jpg',
  ];
                ...
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                'http://192.168.1.83:8000/asset/Commercial-new/NightLife/3.Mint/Menu/MintMenu-1.jpg'),
                            fit: BoxFit.cover),
                        borderRadius: BorderRadius.circular(10)),
                    width: size.width,
