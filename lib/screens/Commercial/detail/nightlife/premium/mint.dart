...
class _MintState extends State<Mint> {
 late YoutubePlayerController _youtubeController;
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/3.Mint/Top/MintTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/3.Mint/Top/MintTop-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/3.Mint/Top/MintTop-3.jpg',
  ];

  final List<String> RoomImage = [
     // Services
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/3.Mint/Service/Service1/MintService1-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/NightLife/3.Mint/Service/Service2/MintService-1.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'The number one clubbing destination in Ulaanbaatar, Mongolia',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.90454;
                                double longitude = 106.92795;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/NightLife/3.Mint/Menu/MintMenu-1.jpg'),
                                fit: BoxFit.cover),
                                borderRadius: BorderRadius.circular(10)
                              ),
                              width: size.width,
