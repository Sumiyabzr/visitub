...
class Odkhuu extends StatefulWidget {
  const Odkhuu({super.key});

  @override
  State<Odkhuu> createState() => _OdkhuuState();
}

class _OdkhuuState extends State<Odkhuu> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/4.Odkhuu/Top/OdkhuuTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/4.Odkhuu/Top/OdkhuuTop-2.jpg',
  ];

  final List<String> RoomImage = [
     // Product
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/4.Odkhuu/Product/OdkhuuProduct-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/4.Odkhuu/Product/OdkhuuProduct-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/4.Odkhuu/Product/OdkhuuProduct-3.jpg',
  ];
