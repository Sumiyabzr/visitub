...
class RoboEagle extends StatefulWidget {
  const RoboEagle({super.key});

  @override
  State<RoboEagle> createState() => _RoboEagleState();
}

class _RoboEagleState extends State<RoboEagle> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/1.Robo Eagle/Top/RoboEagleTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/1.Robo Eagle/Top/RoboEagleTop-2.jpg',
  ];

  final List<String> RoomImage = [
     // Product
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/1.Robo Eagle/Product/RoboEagleProduct-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/1.Robo Eagle/Product/RoboEagleProduct-5.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/1.Robo Eagle/Product/RoboEagleProduct-9.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/1.Robo Eagle/Product/RoboEagleProduct-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Shopping/1.Robo Eagle/Product/RoboEagleProduct-1.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Padding(
                                          padding: EdgeInsets.only(left: 10),
                                          child: Text(
                                            'Drone store in Mongolia /\nДрон дэлгүүр РобоИЙГЛ ',
                                          ),
                                        ),
                                      ],
                                    ),
                                    ...
                                    Text(
                                      'Robo Eagle: Cutting-edge electronics and gadgets store in Ulaanbaatar, offering robotics and smart devices.',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.90304;
                                double longitude = 106.92904;
