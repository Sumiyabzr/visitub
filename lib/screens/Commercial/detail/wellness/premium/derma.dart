...
class Derma extends StatefulWidget {
  const Derma({super.key});

  @override
  State<Derma> createState() => _DermaState();
}

class _DermaState extends State<Derma> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/2.Derma/Top/DermaTop-1.jpg',
  ];

  final List<String> RoomImage = [
     // Services
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/2.Derma/Services/DermaService-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/2.Derma/Services/DermaService-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/2.Derma/Services/DermaService-3.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'Дермастетик Арьс Гоо Засал Пластик Мэс Заслын Эмнэлэг',
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.90406;
                                double longitude = 106.91780;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/Wellness/2.Derma/Menu/Menu/DermaMenu-1.jpg'),
                                fit: BoxFit.cover),
                                borderRadius: BorderRadius.circular(10)
                              ),
                              width: size.width,
