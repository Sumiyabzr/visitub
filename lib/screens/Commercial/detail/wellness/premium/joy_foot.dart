...
class JoyFoot extends StatefulWidget {
  const JoyFoot({super.key});

  @override
  State<JoyFoot> createState() => _JoyFootState();
}

class _JoyFootState extends State<JoyFoot> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/3.Joy Foot Massage/Top/JoyFootMassageTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/3.Joy Foot Massage/Top/JoyFootMassageTop-2.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/3.Joy Foot Massage/Top/JoyFootMassageTop-3.jpg',
  ];

  final List<String> RoomImage = [
     // Services
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/3.Joy Foot Massage/Services/Service1/JoyFootMassageService-3.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/3.Joy Foot Massage/Services/Service2/JoyFootMassageService-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/3.Joy Foot Massage/Services/Service3/JoyFootMassageService-4.jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.90525;
                                double longitude = 106.91043;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/Wellness/3.Joy Foot Massage/Menu/JoyFootMassageMenu-1.jpg'),
                                fit: BoxFit.cover),
                                borderRadius: BorderRadius.circular(10)
                              ),
                              width: size.width,
