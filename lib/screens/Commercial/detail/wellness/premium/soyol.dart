...
class Soyol extends StatefulWidget {
  const Soyol({super.key});

  @override
  State<Soyol> createState() => _SoyolState();
}

class _SoyolState extends State<Soyol> {
  ...
  final List<String> TopImage = [
     // TOP
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/1.Soyol/Top/SoyolTop-1.jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/1.Soyol/Top/SoyolTop-2.jpg',
  ];

  final List<String> RoomImage = [
     // Services
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/1.Soyol/Service/Service-1/SoyolService1 (1).jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/1.Soyol/Service/Service-2/SoyolService2 (1).jpg',
    'http://192.168.1.111:8000/asset/Commercial-new/Wellness/1.Soyol/Service/Service-3/SoyolService3 (1).jpg',
  ];
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    // Text(
                                    //   'Mongolia`s leading night club with the latest, powerful Void Acoustic sound system, amazing Madrix Light, MadrixMaxx light system and an impressive MagicFx CO2 shot machine.',
                                    // ),
                                  ],
                                ),
                              ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                double latitude = 47.90035;
                                double longitude = 106.89205;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/Commercial-new/Wellness/1.Soyol/Menu/SoyolMenu-2.jpg'),
                                fit: BoxFit.cover),
                                borderRadius: BorderRadius.circular(10)
                              ),
                              width: size.width,
