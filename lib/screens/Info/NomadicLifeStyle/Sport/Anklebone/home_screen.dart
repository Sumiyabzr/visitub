...
class _AnkleboneState extends State<Anklebone> {
  List<String> images = [
    "http://192.168.1.83:8000/asset/anklethumb.jpg",
    "http://192.168.1.83:8000/asset/ankle1.jpg",
    "http://192.168.1.83:8000/asset/ankle2.jpg",
    "http://192.168.1.83:8000/asset/ankle3.jpg",
    "http://192.168.1.83:8000/asset/ankle4.jpg",
    "http://192.168.1.83:8000/asset/ankle5.jpg"
  ];
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      fit: BoxFit.cover, image: NetworkImage(images[5]))),
              child: Container(
