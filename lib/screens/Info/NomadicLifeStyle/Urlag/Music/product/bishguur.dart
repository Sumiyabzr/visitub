              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                   ...
                   GestureDetector(
                    onTap: () => Navigator.popAndPushNamed(context, '/shamandrum'),
                    child: Container(
                      color: Colors.white,
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(children: 
                        [
                          Text('Continue reading Shaman Drum', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12),),
