        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/shamanism1.jpg'), fit: BoxFit.cover)
            ),
            width: size.width,
              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(image: NetworkImage('http://192.168.1.111:8000/asset/shamanism1.jpg'))
                      ),
                    ),
                    SizedBox(width: 10,),
                    Text('Болд Зайран', style: TextStyle(
                ...
                Container(
                  ...
                  child: Padding(padding: EdgeInsets.all(15),
                    child: Column(
                      children: [
                        Text('Great cashmere should be comfortable responsibly made, humane and in your budget—and at GOBI Cashmere we’ve proven that it can since 1981.', textAlign: TextAlign.justify,),
                        SizedBox(height: 10,),
                        Row(
                          children: [
                        ...
                        SizedBox(height: 10,),
                          Row(
                          children: [
                            Icon(Icons.facebook, color: Colors.blue.shade300,),
                            SizedBox(width: 5,),
                            Text('Gobi Cashmere')
                          ],
                        ),
                          ...
                          Row(
                          children: [
                            Icon(Icons.alarm, color: Colors.blue.shade300,),
                            SizedBox(width: 5,),
