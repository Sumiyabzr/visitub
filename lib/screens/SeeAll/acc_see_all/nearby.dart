...
class AccNearbySeeAll extends StatefulWidget {
  const AccNearbySeeAll({super.key});

  @override
  State<AccNearbySeeAll> createState() => _AccNearbySeeAllState();
}

class _AccNearbySeeAllState extends State<AccNearbySeeAll> {
  @override
