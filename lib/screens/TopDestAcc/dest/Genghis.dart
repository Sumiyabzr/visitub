...
class TopGenghis extends StatefulWidget {
  const TopGenghis({super.key});

  @override
  State<TopGenghis> createState() => _TopGenghisState();
}

class _TopGenghisState extends State<TopGenghis> {
              ...
              children: [
                    ...
                    children: [
                      Image.network(
                          "http://192.168.1.111:8000/asset/" +
                              provider.getCategoryProducts(0)[0]['thumb'],
                          fit: BoxFit.cover),
                      Align(
                        alignment: Alignment.center,
                        child: IconButton(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        provider.getCategoryProducts(0)[0]['name'],
                        style: TextStyle(
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            provider.getCategoryProducts(0)[0]['location'],
                            style: TextStyle(
                              fontSize: 15,
                          ...
                          SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemBuilder: (content, index) => Container(
                                ...
                                child: Center(
                                  child: Text(
                                    provider.getCategoryProducts(0)[0][
                ...
                Stack(children: [
                  SizedBox(
                    ...
                    child: PageView.builder(
                        itemCount:
                            provider.getCategoryProducts(0)[0]['images'].length,
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: Image.network(
                                "http://192.168.1.111:8000/asset/" +
                                    provider.getCategoryProducts(0)[0]['images']
                                        [index],
                                fit: BoxFit.cover,
                              ),
                            ),
