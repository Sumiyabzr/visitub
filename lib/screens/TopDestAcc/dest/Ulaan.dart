...
class TopUlaanTsutgalan extends StatefulWidget {
  const TopUlaanTsutgalan({super.key});

  @override
  State<TopUlaanTsutgalan> createState() => _TopUlaanTsutgalanState();
}

class _TopUlaanTsutgalanState extends State<TopUlaanTsutgalan> {
              ...
              children: [
                    ...
                    children: [
                      Image.network(
                          "http://192.168.1.83:8000/asset/" +
                              provider.getCategoryProducts(1)[4]['thumb'],
                          fit: BoxFit.cover),
                      Align(
                        alignment: Alignment.center,
                        child: IconButton(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        provider.getCategoryProducts(1)[4]['name'],
                        style: TextStyle(
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            provider.getCategoryProducts(1)[4]['location'],
                            style: TextStyle(
                              fontSize: 15,
                          ...
                          SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemBuilder: (content, index) => Container(
                                ...
                                child: Center(
                                  child: Text(
                                    provider.getCategoryProducts(1)[4][
                ...
                Stack(children: [
                  SizedBox(
                    ...
                    child: PageView.builder(
                        itemCount:
                            provider.getCategoryProducts(1)[4]['images'].length,
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: Image.network(
                                "http://192.168.1.83:8000/asset/" +
                                    provider.getCategoryProducts(1)[4]['images']
                                        [index],
                                fit: BoxFit.cover,
                              ),
                            ),
