...
class AsaLand extends StatefulWidget {
  final String data;
  const AsaLand(this.data, {super.key});

  @override
  State<AsaLand> createState() => _AsaLandState();
}

class _AsaLandState extends State<AsaLand> {
                      ...
                      children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      provider.getProducts(widget.data)![1][1]
                                          [0]['name'],
                                      style: TextStyle(
                                          fontSize: 20,
                        ...
                        Stack(children: [
                          SizedBox(
                            ...
                            child: PageView.builder(
                                itemCount: provider
                                    .getProducts(widget.data)![1][1][0]['Image']
                                    .length,
