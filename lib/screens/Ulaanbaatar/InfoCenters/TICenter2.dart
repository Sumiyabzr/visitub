...
class TouristInformationCenter2 extends StatefulWidget {
  const TouristInformationCenter2({super.key});

  @override
  State<TouristInformationCenter2> createState() =>
      _TouristInformationCenter2State();
}

class _TouristInformationCenter2State extends State<TouristInformationCenter2> {
  @override
                  ...
                  children: [
                    GestureDetector(
                      onTap: () async {
                        ...
                        double latitude = 47.90861;
                        double longitude = 106.88368;
