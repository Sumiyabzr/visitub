...
class ChinggisKhaanMuseum extends StatefulWidget {
  const ChinggisKhaanMuseum({super.key});

  @override
  State<ChinggisKhaanMuseum> createState() => _ChinggisKhaanMuseumState();
}
...
class _ChinggisKhaanMuseumState extends State<ChinggisKhaanMuseum> {
  ...
  List data = [
    [
      ...
      "Step into the epic legacy of the great Chinggis Khaan at the Chinggis Khaan Museum, located in the heart of Ulaanbaatar, Mongolia. This state-of-the-art museum pays homage to the legendary leader, offering visitors an immersive experience into the life, conquests, and cultural impact of Chinggis Khaan and the Mongolian Empire. Explore captivating exhibits featuring artifacts, interactive displays, and historical relics that unveil the fascinating story of one of history's most influential figures. Engage with the rich nomadic heritage, military prowess, and visionary leadership that defined the era. The Chinggis Khaan Museum invites you to journey through time, gaining a deeper appreciation for the enduring legacy of the great Khaan and the Mongolian people."
    ]
  ];
