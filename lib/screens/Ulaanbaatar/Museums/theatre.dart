...
class TheatreMuseum extends StatefulWidget {
  const TheatreMuseum({super.key});

  @override
  State<TheatreMuseum> createState() => _TheatreMuseumState();
}
...
class _TheatreMuseumState extends State<TheatreMuseum> {
  ...
  List data = [
    [
      "Theatre Museum",
      "Unveil the captivating world of Mongolian theater at the Theatre Museum of Mongolia in Ulaanbaatar. This cultural sanctuary celebrates the vibrant tapestry of Mongolian performing arts, tracing the evolution of theater from traditional nomadic performances to modern stage productions. Immerse yourself in the costumes, scripts, and memorabilia that narrate the fascinating journey of Mongolian drama and storytelling. With interactive exhibits and a spotlight on influential figures in the theater community, the museum invites visitors to appreciate the artistry, creativity, and cultural significance of Mongolian theater. Explore the stages of the past and present, where every corner echoes the applause of a rich theatrical heritage."
    ]
  ];
